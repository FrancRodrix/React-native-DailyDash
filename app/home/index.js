...
const index = () => {
  ...
  const handleCompletion = async () => {
    try {
      ...
      await axios.put(`http://localhost:3000/tasks/${taskId}/completed`, {
  ...
  const filteredTasks = tasks?.filter((task) => {
    return !task.completed || !task.completed[currentDay];
  });

  const days = ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"];

  console.log("filtered habbits", tasks);
    ...
    <>
      <ScrollView style={{ flex: 1, backgroundColor: "#fff", padding: 10 }}>
        ...
        >
          ...
          <Text style={{ marginTop: 5, fontSize: 23, fontWeight: "500",color:'red' }}>
          DailyDash
        </Text>
          </View>
          ...
          <AntDesign
            ...
            color="black"
          />
          <Text style={{ fontSize: 23, fontWeight: "500" }}>Create Task</Text>
          </Pressable>
            ...
            {tasks?.map((task, index) => (
              ...
              >
                ...
                >
                  ...
                  <Text style={{ color: "white" }}>{task.repeatMode}</Text>
                </View>
      ...
      >
        <ModalContent style={{ width: "100%", height: 200, marginBottom: 20 }}>
